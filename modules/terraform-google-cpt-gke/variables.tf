...
variable "enable_bastion" {
  type = bool
  description = "If enabled, a bastion host will be added to connect to the cluster"
  default = false
}

variable "enable_nat" {
  type = bool
  description = "If enabled, a nat gateway will be created alongside the bastion"
  default = false
}
...
variable "binauthz" {
  ...
  description = "Binary authorization & break glass procedure settings. WARNING: if this enabled then monitoring workspace needs to be manualy created before running, please see: https://github.com/hashicorp/terraform-provider-google/issues/2605 for more details"
}